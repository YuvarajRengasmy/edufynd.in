        ...
        <div className="row justify-content-center">
          <div className="contet-header">
            <h5
              ...
              style={{ fontWeight: "bold", color: "#0f2239" }}
            >
              {" "}
              <span style={{ fontWeight: "bolder" }}>S</span>tudy{" "}
              <span style={{ fontWeight: "bolder" }}>A</span>broad{" "}
            ...
            >
              Choose the Best{" "}
              <span style={{ color: "#fe5722", fontWeight: "normal" }}>
                Study Abroad Destination with EduFynd
              </span>
            </h2>
          </div>
          <div
          ...
          >
            <div className="col-md-4">
              <div class="card  rounded-2  shadow-sm  position-relative">
                <Link to="/Study-In-USA" className="">
                  {" "}
                  <img
                ...
                <div class="card-body">
                  ...
                  <div className=" ">
                    <Link
                      to="/Study-In-USA"
                      className="btn btn-sm fw-semibold rounded-1 position-absolute top-100 start-50 translate-middle  px-4 py-2 "
                      style={{
            ...
            <div className="col-md-4">
              <div class="card  rounded-2  shadow-sm  position-relative">
                <Link to="/Study-In-Canada" className="">
                  <img
          ...
          <div className="row g-5 " data-aos="slide-right">
            ...
            <div className="col-md-4">
              <div class="card  rounded-2  shadow-sm  position-relative">
                <Link to="/Study-In-Ireland" className="">
                  <img
            ...
            <div className="col-md-4">
              <div class="card  rounded-2  shadow-sm  position-relative">
                <Link to="/Study-In-New-Zealand" className="">
                  {" "}
                  <img
          ...
          <div className="row g-5" data-aos="slide-right">
            <div className="col-md-4">
              <div class="card  rounded-2  shadow-sm  position-relative">
                <Link to="/Study-In-Signapore" className="">
                  {" "}
                  <img
                    src="https://img.freepik.com/free-photo/flag-singapore_1401-220.jpg"
                    class="  img-fluid img-thumbnail rounded-circle  mx-auto d-block "
                    style={{ width: "7rem", height: "7rem" }}
                    alt="..."
                  />
            ...
            <div className="col-md-4">
              <div class="card  rounded-2  shadow-sm  position-relative">
                <Link to="/Study-In-Europe" className="">
                  {" "}
                  <img
                    src="https://t3.ftcdn.net/jpg/00/17/53/68/360_F_17536806_VTROYDmML98aIvVxL6RqzppcyaT4kB06.jpg"
                    class="  img-fluid img-thumbnail rounded-circle  mx-auto d-block "
                    style={{ width: "7rem", height: "7rem" }}
                    alt="..."
                  />
            ...
            <div className="col-md-4">
              <div class="card  rounded-2  shadow-sm  position-relative">
                <Link to="/Study-In-France" className="">
                  <img
