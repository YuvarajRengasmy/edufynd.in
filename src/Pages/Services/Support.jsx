        ...
        <div className="row">
          ...
          <div className="col-md-7">
            <p className="text-muted py-2" style={{ textAlign: "justify" }}>
              ...
              enriching academically but also smooth, supported, and
              memorable.From the Moment You Plan to the Day You Land, We've Got
              You Covered.
            </p>
        ...
        <div className="row g-5  justify-content-center">
            ...
            <div className=" card h-100 position-relative  rounded-0 border-0 shadow-lg  p-3">
              <div className="card-body ">
                ...
                <p
                  ...
                  style={{ color: "#0f2239", textAlign: "justify" }}
                >
                  Before you embark on your study abroad journey, our
                  comprehensive pre-departure guidance equips you for success.
                  We provide essential information, resources, and support to
                  ensure you are well-prepared, confident, and ready to embrace
                  your new academic adventure.
                </p>
            ...
            <div className=" card h-100 position-relative  rounded-0 border-0 shadow-lg  p-3">
              <div className="card-body ">
                ...
                <p
                  ...
                  style={{ color: "#0f2239", textAlign: "justify" }}
                >
                  Upon your arrival, our commitment doesn't end. Our
                  post-landing support is designed to facilitate a seamless
                  transition into your new environment. From navigating cultural
                  adjustments to understanding academic expectations, we're here
                  to ensure your comfort and confidence as you begin this
                  exciting chapter.
                </p>
                <div className="position-absolute position-absolute bottom-0 start-50 translate-middle-x py-2  ">
                  <a
          ...
          <div className="col-md-4">
            <div className=" card h-100 position-relative  rounded-0 border-0 shadow-lg  p-3">
              <div className="card-body ">
                <h5 className="card-title fw-bold" style={{ color: "#0f2239" }}>
                  Stress-Free Housing Solutions
                </h5>
                <p
                  className="card-text"
                  style={{ color: "#0f2239", textAlign: "justify" }}
                >
                  We understand the importance of a comfortable living space.
                  Our team goes the extra mile to help you find suitable housing
                  that aligns with your preferences and budget, making sure your
                  journey is stress-free right from the start.
                </p>
                <div className="position-absolute position-absolute bottom-0 start-50 translate-middle-x py-2  ">
                  <a
                    href=""
