      ...
      <div className="container my-5">
        <div className="row">
          ...
          <div className="col-md-7">
            ...
            <h4 className="text-start fw-bold">
              Crafting Persuasive Scholarship Essays:
            </h4>
            <p className="text-muted py-2" style={{ textAlign: "justify" }}>
              In addition to loan assistance, we excel at crafting compelling
              scholarship essays that elevate your application.At EduFynd, our
              commitment is to provide holistic support, ensuring you have the
              financial resources needed to pursue your educational goals. From
              navigating loans to crafting standout scholarship essays, we're
          ...
          <div className="col-md-5">
            <div className="h-100 text-center">
              <img
                ...
                alt=""
                className="img-fluid w-100  h-100 mx-auto d-block "
              />
            </div>
          </div>
        </div>
            ...
            <div className=" card h-100 position-relative   shadow-sm p-3">
              <div className="card-body ">
                ...
                <p
                  ...
                  style={{ color: "#0f2239", textAlign: "justify" }}
                >
                  Our team specializes in identifying a range of loan options
                  tailored to meet your specific financial needs, ensuring you
                  have access to the resources necessary for your education.
                </p>
                <div className="position-absolute position-absolute bottom-0 start-50 translate-middle-x py-2  ">
                  <a
                    href=""
                    className="btn btn-sm text-uppercase fw-semibold px-4 py-2  "
            ...
            <div className=" card h-100 position-relative   shadow-sm p-3">
              <div className="card-body ">
                ...
                <p
                  ...
                  style={{ color: "#0f2239", textAlign: "justify" }}
                >
                  We provide insights into interest rates, helping you make
            ...
            <div className=" card h-100 position-relative   shadow-sm p-3">
              <div className="card-body ">
                ...
                <p
                  ...
                  style={{ color: "#0f2239", textAlign: "justify" }}
                >
                  Our experts conduct thorough eligibility assessments, guiding
                  you toward loan solutions that match your financial situation.
                </p>
                <div className="position-absolute position-absolute bottom-0 start-50 translate-middle-x py-2  ">
                  <a
                    href=""
                  ...
                  <div class="modal-dialog modal-dialog-scrollable">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <button
                          type="button"
                          class="btn btn-sm text-uppercase fw-semibold px-4 py-2 -close"
                      ...
                      <div class="modal-body">
                        ...
                        >
                          ...
                          <div class="modal-footer">
                            <button
                              type="button"
                              class="btn btn-sm text-uppercase fw-semibold px-4 py-2   fw-semibold btn-secondary"
                              data-bs-dismiss="modal"
                              style={{
                            ...
                            <button
                              type="submit"
                              class="btn btn-sm text-uppercase fw-semibold px-4 py-2  fw-semibold "
                              data-bs-dismiss="modal"
                              style={{
                                backgroundColor: "#fe5722",
                                color: "#fff",
