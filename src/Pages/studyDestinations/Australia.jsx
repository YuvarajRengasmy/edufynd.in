  ...
  return (
    <div>
      <Helmet>
        ...
        <title>
          Study in Australia | Top Australia Universities, Courses, Fees & Visa
          Support
        </title>
            ...
            <div class="card p-3">
              ...
              <div class="card-body">
                ...
                >
                  ...
                  Australia boasts an impressive count of 38 universities listed
                  in the prestigious QS World University Rankings, providing
                  compelling reasons to consider it as your study destination.
                  With diverse specializations available in both Master's and
                  MBA programs, Australia not only promises a quality education
                  but also offers enticing post-study work opportunities, making
                  it an attractive choice for international students.
                </p>
                <p
                  class="card-text fw-semibold"
                  style={{ color: "#0f2239", textAlign: "justify" }}
                >
                  ...
                  A significant portion of this global student community,
                  comprising over 99,000 individuals, includes Indian students
                  demonstrating a strong preference for Master's and MBA
                  programs in Australia. However, before embarking on your
                  educational journey Down Under, it's essential to weigh the
                  crucial financial aspects.{" "}
                </p>
                <p
                  class="card-text fw-semibold"
                  style={{ color: "#0f2239", textAlign: "justify" }}
                >
                  ...
                  Many students turn to education loans to fund their studies,
                  underscoring the significance of exploring available options.
                  Making an informed decision about your educational pursuit
                  involves understanding and navigating the diverse financial
                  avenues available for your studies in Australia.{" "}
                </p>
              </div>
            </div>
            <div className="border my-4">
              ...
              >
                <li class="nav-item " role="presentation">
                  <a
                    class="nav-link text-uppercase active fw-bold px-1 py-3 rounded-0"
                    style={{ color: "#fe5722" }}
                    id="home-tab"
                    data-bs-toggle="tab"
                    href="#tab-home"
                ...
                <li class="nav-item  " role="presentation">
                  <a
                    class="nav-link text-uppercase  fw-bold px-1 py-3 rounded-0"
                    style={{ color: "#fe5722" }}
                    id="profile-tab"
                    data-bs-toggle="tab"
                    href="#tab-profile"
              ...
              <div class="tab-content mt-3" id="myTabContent">
                ...
                >
                  ...
                  >
                    ...
                    Embark on your educational journey in a nation that has
                    produced over 2.5 million global graduates and is renowned
                    for its exceptional standards in global education.{" "}
                  </p>
                  <p
                    class=" fw-semibold"
                    style={{ color: "#0f2239", textAlign: "justify" }}
                  >
                    ...
                    Obtain high-quality and globally recognized qualifications
                  ...
                  >
                    ...
                    Elevate your career prospects by acquiring hands-on industry
                    experience through placements and internships, forging
                    connections with international employers, and positioning
                    yourself for success in the global workforce.{" "}
                  </p>
                  <p
                    class=" fw-semibold"
                    style={{ color: "#0f2239", textAlign: "justify" }}
                  >
                    ...
                    Experience a warm and inspiring atmosphere in some of the
                    world's most liveable cities, enriched by a diverse mix of
                    nationalities and cultures from around the globe.{" "}
                  </p>
                </div>
                <div
                ...
                >
                  ...
                  >
                    ...
                    Select from 9 universities ranked among the world's top 100{" "}
                  </p>
                  <p
                    class=" fw-semibold"
                    style={{ color: "#0f2239", textAlign: "justify" }}
                  >
                    ...
                    Explore a diverse array of over 22,000 courses offered by
                    1,100 institutions.{" "}
                  </p>
                  <p
                    class=" fw-semibold"
                  ...
                  >
                    ...
                    Experience student life in 7 of the best cities globally, as
                    per QS Best Student Cities 2023.{" "}
                  </p>
                  <p
                    class=" fw-semibold"
                    style={{ color: "#0f2239", textAlign: "justify" }}
                  >
                    ...
                    Access over A$300 million invested in scholarships for
                  ...
                  >
                    ...
                    Benefit from the prestige of Australian universities, which
                    have produced 15 Nobel Laureates.{" "}
                  </p>
                  <p
                    class=" fw-semibold"
                    style={{ color: "#0f2239", textAlign: "justify" }}
                  >
                    ...
                    Join a community of over half a million international
                  ...
                  >
                    ...
                    Enjoy the opportunity of a post-study work visa for up to 6
                    years*.
                  </p>
                  <p
                    class=" fw-semibold"
                  ...
                  >
                    ...
                    Explore promising prospects for obtaining permanent
                    residency.{" "}
                  </p>
                </div>
                <div
                ...
                >
                  <h4 class="fw-bold py-2" style={{ color: "#0f2239" }}>
                    Popular Courses to Study in theAustralia
                  </h4>
                ...
                >
                  <h4 class="fw-bold py-2" style={{ color: "#0f2239" }}>
                    Cost of Living and Studying in the Australia
                  </h4>
                  <h5 class="fw-bold py-2" style={{ color: "#0f2239" }}>
                    Yearly Fees for Studying in The Australia
                  </h5>
                  ...
                  <h5 class="fw-bold py-2" style={{ color: "#0f2239" }}>
                    Monthly Expenses of Staying in The Australia
                  </h5>
