  ...
  return (
    <div>
      <Helmet>
        ...
        <title>
          Study in Singapore | Top Canada Universities, Courses, Fees & Visa
          Support
        </title>
        ...
        <div className="row">
          <div className="col-md-9 ">
            <div class="card p-3">
              ...
              <div class="card-body">
                ...
                >
                  ...
                  Choose Singapore for an exceptional education system, obtain
                  globally recognized qualifications from top-ranked
                  institutions, and immerse yourself in a multicultural society
                ...
                >
                  ...
                  international students. Securing an education loan for the
                  Singapore emerges as an excellent financial strategy to cover
                ...
                >
                  ...
                  when applying for Singapore student visas, streamlining the
            ...
            <div className="border-0 rounded-2 shadow-sm my-4">
              <ul
                class="nav nav-underline rounded-0  fs-9"
                id="myTab"
                role="tablist"
                style={{ fontSize: "12px" }}
              >
              ...
              <div
                class="tab-content rounded-0 border-0 mt-3"
                id="myTabContent"
              >
                <div
                ...
                >
                  ...
                  >
                    ...
                    Rising as Asia's premier international study hub, Singapore,
                    a city of skyscrapers, attracts students globally.
                  </p>
                  <p
                    class=" fw-semibold"
                    style={{ color: "#0f2239", textAlign: "justify" }}
                  >
                    ...
                    Renowned for academic excellence, its universities
                  ...
                  >
                    ...
                    Serving as the IT & Business hub of Asia, Singapore offers a
                    dynamic environment.{" "}
                  </p>
                  <p
                    class=" fw-semibold"
                  ...
                  >
                    ...
                    The city excels in student satisfaction, safety, and
                    affordability, making it a coveted study destination.{" "}
                  </p>
                  <p
                    class=" fw-semibold"
                    style={{ color: "#0f2239", textAlign: "justify" }}
                  >
                    ...
                    As an economic powerhouse with diverse job opportunities,
                    Singapore's international repute in education reinforces its
                    status as a sought-after global study destination.{" "}
                  </p>
                </div>
                <div
                ...
                >
                  ...
                  >
                    ...
                    Ranked as the second-best country for living and working in
                    the 2019 HSBC ranking, this nation boasts two universities
                    within the global top 20.{" "}
                  </p>
                  <p
                    class=" fw-semibold"
                    style={{ color: "#0f2239", textAlign: "justify" }}
                  >
                    ...
                    Serving as a key financial hub globally, it houses
                    institutions affiliated with leading international
                    universities in the USA, the Singapore, Canada, and
                    Australia.{" "}
                  </p>
                  <p
                    class=" fw-semibold"
                  ...
                  >
                    ...
                    Students enjoy transfer opportunities to the parent campus,
                    one-year master's programs, and bachelor's programs spanning
                    2 or 3 years.{" "}
                  </p>
                  <p
                    class=" fw-semibold"
                  ...
                  >
                    ...
                    The diverse internship options, coupled with affordable
                    tuition and living expenses, make it an attractive
                    destination, with numerous scholarships available.{" "}
                  </p>
                </div>
                <div
                  class="tab-pane fade p-4 "
                ...
                >
                  <h4 class="fw-bold py-2" style={{ color: "#0f2239" }}>
                    Top Courses to Study in the Singapore
                  </h4>
                ...
                >
                  <h4 class="fw-bold py-2" style={{ color: "#0f2239" }}>
                    Cost of Living and Studying in the Singapore
                  </h4>
                  <p
                    class=" fw-semibold"
                    style={{ color: "#0f2239", textAlign: "justify" }}
                  >
                    ...
                    The cost of education and living in the Singapore is
                    influenced by the university and program you choose. Here's
                    a breakdown of the yearly fees for studying in the Singapore
                    and estimated monthly expenses:
                  </p>

                  <h5 class="fw-bold py-2" style={{ color: "#0f2239" }}>
                    Yearly Fees for Studying in The Singapore
                  </h5>
                  ...
                  <h5 class="fw-bold py-2" style={{ color: "#0f2239" }}>
                    Monthly Expenses of Staying in The Singapore
                  </h5>
