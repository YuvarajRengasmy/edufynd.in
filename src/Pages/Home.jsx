                  ...
                  <div className="carousel-item active hero1 "  >
                    ...
                    <div className="hero-content1 position-absolute top-50 start-0 translate-middle-y text-white">
                      ...
                      <div className="py-2 animate__animated animate__fadeInUp" style={{ animationDelay: '1.3s' }}>
                        <Link to="/Contact" className="btn btn-sm px-4 py-2 text-uppercase fw-semibold text-white " style={{ backgroundColor: "#fe5722",fontSize:'12px' }}>
                          Connect with Experts <span className="ms-1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span>
                        </Link>
                      </div>
                    </div>
                  </div>
              ...
              <div className="position-absolute top-50 end-0 translate-middle-y mt-5 px-5 pt-5 d-none d-lg-block"   >
                ...
                <form className="enquiry-form">
                  ...
                  <div className="input-group mb-3">
                    <Link to="#" className="btn btn-sm px-4 py-2 text-uppercse fw-semibold  dropdown-toggle border-0 " type="button" data-bs-toggle="dropdown" aria-expanded="false" style={{ background: "#fe5722", color: "#fff",fontSize:'12px' }}>
                      +91
                    </Link>
                    <ul className="dropdown-menu" >
                      <li><Link to="#" className="dropdown-item">+101</Link></li>
                      <li><Link to="#" className="dropdown-item">+93</Link></li>
                      <li><Link to="#" className="dropdown-item">+54</Link></li>
                    </ul>
                    <input type="text" className="form-control form-control-lg" aria-label="Text input with dropdown" placeholder="Contact No" />
                  </div>
                  <div className="form-floating mb-3">
                    <textarea className="form-control form-control-lg" placeholder="Message" id="floatingTextarea" style={{ height: " 100px" }}></textarea>
                    <label htmlFor="floatingTextarea">Message</label>
                  </div>
                  <div className="mb-3">
                    <button type="submit" className="btn text-white fw-semibold text-uppercase border-0 shadow-sm px-4 py-2" style={{ backgroundColor: "#fe5722",fontSize:'12px' }}>
                      Submit <span className="ms-1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span>
                    </button>
                  </div>
                </form>
              </div>
          ...
          <div className="row g-3">
            ...
            <div className="col-md-4 align-items-center justify-content-center" data-aos="slide-right">
              ...
              <div className="col my-3">
                <Link to="/StudyDestination"  className="btn btn-sm text-white text-uppercase fw-semibold px-4 py-2 shadow-sm" style={{ color: 'white', backgroundColor: '#fe5722',fontSize:'12px' }}>
                  View All Countries <span className="ms-1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span>
                </Link>
              </div>
            </div>
                    ...
                    <div className=" card border-0 shadow card-country" key={index}>
                      ...
                      <div className="card-body">
                        ...
                        <div className="mt-3 text-center">
                          <Link to="/StudyDestination" className="btn btn-sm text-white text-uppercase fw-semibold px-4 py-2" style={{ backgroundColor: '#fe5722',fontSize:'12px' }}>
                            Explore More <span className="ms-1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span>
                          </Link>
                        </div>
                      </div>
                    </div>
        ...
        <div className="container mt-5 overflow-hidden" data-aos="zoom-in">
          <div className="row">
            <div className="col-lg-6"   >
              <div className="row d-flex">
                <div className="col-sm-8 justify-content-start" >
                  <img src={home2} alt="about Image1" className="img-fluid rounded-2" />
                </div>
              ...
              <div className="row ">
                <div className="col position-relative">
                  <img src={about_1_shape1} alt="about Image3" className="rounded-2  img-fluid vert-move" />
                  <img src={about_5_1shape} alt="" className='img-fluid  position-absolute bottom-0 start-0 vert-move' />
                </div>

                <div className="col position-relative">
                  <img src={home1} alt="about Image4" className="rounded-2 img-fluid   position-absolute bottom-0 end-0" />
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-6"  >
              ...
              <div className="mt-3">
                <Link to="/About"  className="btn btn-sm text-white text-uppercase fw-semibold px-4 py-2 shadow-sm" style={{ backgroundColor: '#fe5722',fontSize:'12px' }}>
                  View More <span className="ms-1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span>
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="row g-3">
              <div className="col-lg-6" data-aos="slide-right">
                ...
                <div className="text-end mt-4">
                  <Link to="/About"  className="btn btn-sm text-white fw-semibold text-uppercase px-4 py-2 border-0 shadow-sm" style={{ backgroundColor: '#fe5722',fontSize:'12px' }}>get started <span className="ms-1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span></Link>
                </div>
              </div>
              ...
              <div className="col text-center">
                <div className="text-center mt-2">
                  ...
                  <div className="text-center my-5">
                    <Link to="/RecruitingPartner"  className="btn btn-transparent btn-outline-light text-uppercase px-4 py-3 fw-bold">partner with us <span className="fs-5"><FaArrowRightLong /></span></Link>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row g-4">
                <div class="col-lg-4 col-md-6 mb-4">
                  <div class="card pb-4 card-dream h-100 rounded-0 border-0">
                    ...
                    <Link to="/Admission-Support"><span class="fas fa-arrow-right"></span></Link>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                  <div class="card pb-4 card-dream h-100 rounded-0 border-0">
                    ...
                    <Link to="/SOP-Crafting"><span class="fas fa-arrow-right"></span></Link>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                  <div class="card pb-4 card-dream h-100 rounded-0 border-0">
                    ...
                    <Link to="/Visa-Support"><span class="fas fa-arrow-right"></span></Link>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                  <div class="card pb-4 card-dream h-100 rounded-0 border-0">
                    ...
                    <Link to="/Financial-Aid"><span class="fas fa-arrow-right"></span></Link>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                  <div class="card pb-4 card-dream h-100 rounded-0 border-0">
                    ...
                    <Link to="/Pre-and-Post-Support"><span class="fas fa-arrow-right"></span></Link>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                  <div class="card pb-4 card-dream h-100 rounded-0 border-0">
                    ...
                    <Link to="/Forex"><span class="fas fa-arrow-right"></span></Link>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col-sm-5">
                <div className="float-md-end mt-4">
                  <Link to='/Blog' className="btn one btn8 fw-bold fs-6 text-uppercase">
                    View All Posts{" "}
                    <span className="ms-1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span>
                  </Link>
                </div>
              </div>
            </div>
                ...
                <div className="col-md-4 mb-4" data-aos="fade" >
                  <div className="card border-0 h-100" style={{ backgroundColor: 'rgba(0,0,0,0.3)' }}>
                    ...
                    <div className="card-img-overlay d-flex flex-column justify-content-end text-white" >
                      ...
                      <div>
                        <Link to="/Blog-Details" className="btn text-capitalize text-white text-decoration-underline">
                          Read more details <span className="ms-1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span>
                        </Link>
                      </div>
                    </div>
                  </div>
