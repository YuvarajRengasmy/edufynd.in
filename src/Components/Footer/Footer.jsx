  ...
  return (
    <div>
      <div
        ...
        style={{ background: "#0f2239", fontSize: "14px" }}
      >
          ...
          <div className="row ">
            ...
            <div className="col-md-3">
              ...
              <div className="text-white text-left mt-4 px-2">
                ...
                712 H Street NE, Suite 1110, Washington, DC - 20002,
      ...
      <div className="container-fluid" style={{ background: "#0f2239" }}>
        <div className="row">
          ...
          <div className="col-md-8">
            <div className="text-white text-capitalize fw-semibold text-center mt-2">
              <span>
                <FaRegCopyright />
              </span>{" "}
              2024 all rights reserved <span className="two">edufynd</span>
            </div>
          </div>
        </div>
      </div>
